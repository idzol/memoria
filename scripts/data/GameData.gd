...
const ENEMIES = {
	...
	"cat_thief": {
		...
		"icon": "res://assets/cloak.png",
		"loot": ["lockpick"]
	},
	"corrupt_clerk": {
		"name": "Corrupt Clerk",
		"hp": 18, "attack": 4, "biome": "town",
		"icon": "res://assets/scroll.png",
		"loot": ["tax_form", "gold"]
	},
	"feral_cat": {
		"name": "Feral Cat",
		"hp": 8, "attack": 7, "biome": "town",
		"icon": "res://assets/claws.png",
		"loot": ["fur"]
	},
	"loose_armor": {
		"name": "Animated Armor",
	...
	"shadow_wraith": {
		...
		"icon": "res://assets/ghost.png",
		"loot": ["shadow_essence"]
	},
	"dryad_corruptor": {
		"name": "Corrupted Dryad",
		"hp": 45, "attack": 8, "biome": "forest",
		"icon": "res://assets/leaf.png",
		"loot": ["emerald_seed"]
	},
	"briar_beast": {
		"name": "Briar Beast",
		"hp": 55, "attack": 10, "armor": 3, "biome": "forest",
		"icon": "res://assets/thorn.png",
		"loot": ["vine"]
	},
	"feral_hound": {
		"name": "Feral Hound",
		"hp": 20, "attack": 11, "biome": "forest",
		"icon": "res://assets/fang.png",
		"loot": ["pelt"]
	},
	"spore_servant": {
		"name": "Spore Servant",
		"hp": 35, "attack": 6, "biome": "forest",
		"icon": "res://assets/mushroom.png",
		"loot": ["mushroom"]
	},
	"river_lurker": {
		"name": "River Lurker",
		"hp": 40, "attack": 9, "biome": "forest",
		"icon": "res://assets/water.png",
		"loot": ["pearl"]
	},
	"brood_mother": {
		"name": "Brood Mother",
		"hp": 100, "attack": 15, "biome": "forest",
		"icon": "res://assets/spider.png",
		"loot": ["silk", "venom"]
	},
	...
	"sand_spirit": {
		...
		"icon": "res://assets/potion.png",
		"loot": ["potion"]
	},
	"skeleton_soldier": {
		"name": "Desert Soldier",
		"hp": 90, "attack": 22, "biome": "desert",
		"icon": "res://assets/sword.png",
		"loot": ["rusty_sword"]
	},
	"fire_imp": {
		"name": "Fire Imp",
		"hp": 50, "attack": 35, "biome": "desert",
		"icon": "res://assets/bomb.png",
		"loot": ["bomb"]
	},
	"mummy_king": {
		"name": "Mummy King",
		"hp": 200, "attack": 30, "armor": 5, "biome": "desert",
		"icon": "res://assets/bandage.png",
		"loot": ["golden_bandage"]
	},
	"dust_devil": {
		"name": "Dust Devil",
	...
	"lava_slug": {
		...
		"icon": "res://assets/fire.png",
		"loot": ["fire_shard"]
	},
	"steam_mephit": {
		"name": "Steam Mephit",
		"hp": 400, "attack": 120, "biome": "the_core",
		"icon": "res://assets/vapor.png",
		"loot": ["cloud_essence"]
	},
	"iron_golem": {
		"name": "Core Guardian",
...
const NPCS = {
	...
	"blacksmith": {
		...
		"icon": "res://assets/character/base.png",
	...
	"merchant": {
		...
		"icon": "res://assets/character/archivist/base.png",
