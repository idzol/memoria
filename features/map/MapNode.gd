...
func _get_fallback_icon(type: String) -> Texture2D:
	match type:
		"home": return load("res://assets/maps/icon/home.png")
		"battle": return load("res://assets/maps/icon/sword.png")
		"shop": return load("res://assets/maps/icon/shop.png")
		"rest": return load("res://assets/maps/icon/heart.png")
		"event": return load("res://assets/maps/icon/scroll.png")
		"boss": return load("res://assets/maps/icon/skull.png")
	return load("res://assets/maps/icon/trap.png")
